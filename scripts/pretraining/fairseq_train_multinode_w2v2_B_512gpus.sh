#!/bin/bash
#SBATCH --job-name=w2v2_B_pt   # Job name
#SBATCH --output=/fairseq_train_multinode_w2v2_B_512gpus.o # Name of stdout output file
#SBATCH --error=/fairseq_train_multinode_w2v2_B_512gpus.e  # Name of stderr error file
